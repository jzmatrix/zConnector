...
RUN apt-get -y update && \
    ...
    apt-get -y install vim perltidy net-tools lsof curl nmap openssl tzdata gpg ca-certificates cron rsync apt-transport-https fping iputils-ping host whois traceroute && \
